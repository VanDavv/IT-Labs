...
with open('report.txt', 'w') as report:
    ...
    report.write(results.groupby(['randomized', 'type', 'count'])['inserted'].mean().to_string())
    report.write('\n\n')
    report.write('[Avg insert time]\n')
    report.write(results.groupby(['randomized', 'type', 'count'])['insert_time'].mean().to_string())
    report.write('\n\n')
    report.write('[Avg found]\n')
    report.write(results.groupby(['randomized', 'type', 'count'])['search'].mean().to_string())
    report.write('\n\n')
    report.write('[Avg search time]\n')
    report.write(results.groupby(['randomized', 'type', 'count'])['search_time'].mean().to_string())
    report.write('\n\n')
    report.write('[Avg removed]\n')
    report.write(results.groupby(['randomized', 'type', 'count'])['removed'].mean().to_string())
    report.write('\n\n')
    report.write('[Avg remove time]\n')
    report.write(results.groupby(['randomized', 'type', 'count'])['remove_time'].mean().to_string())
    report.write('\n\n')
